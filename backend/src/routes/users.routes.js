...
import { createRole, createUser, deleteUser, listCustomers, listRoles, listUsers, updateUser } from '../controllers/users.controller.js';
...
router.get('/customers', authenticate, authorize('users:write', 'sales:read'), listCustomers);
